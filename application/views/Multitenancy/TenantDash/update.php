            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Update Users</a>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="card">
                            <div class="card-header">
                              ...
                              <a href="TenantDash_Add"><button class="btn btn-success btn-round">Add User</button></a>
                              <a href="TenantDash_Update"><button class="btn btn-warning btn-round">Update User</button></a>
                          ...
                          <div class="card-body">
                              <form>
                                ...
                                <div class="form-row">
                                    <button type="submit" button class="btn btn-warning btn-round">Update</button>
                                </div>
                              </form>
                          </div>
                      </div>
