        ...
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="register/register_user">
                        ...
                        <div class="content">
                           ...
                           <div class="input-group form-group-no-border input-lg">
                               ...
                               <input class="form-control" placeholder="First Name"type="Text" name="UserFirstName" />
                           </div>
                           <div class="input-group form-group-no-border input-lg">
                               <span class="input-group-addon">
                                   <i class="now-ui-icons users_circle-08"></i>
                               </span>
                               <input class="form-control" placeholder="Middle Name"type="Text" name="UserMiddleName" />
                           </div>
                           <div class="input-group form-group-no-border input-lg">
                               <span class="input-group-addon">
                                   <i class="now-ui-icons users_circle-08"></i>
                               </span>
                               <input class="form-control" placeholder="Last Name"type="Text" name="UserLastName" />
                           </div>
                           <div class="input-group form-group-no-border input-lg">
                               <span class="input-group-addon">
                                   <i class="now-ui-icons users_circle-08"></i>
